...
export const mockFeedbacks: IFeedback[] = [
  ...
  },
  {
    ...
    content: 'I have been using this platform for a while now and I must say, the recent updates have made a significant improvement in my workflow. However, I did encounter a few bugs when trying to upload larger files.',
    rating: 3,
    isAnonymous: false,
