          ...
          <div className='flex flex-col sm:flex-row items-center'>
            ...
            <div className='w-full sm:w-1/2 flex items-center gap-4'>
              <Badge className={`${getPlanColor(user.plan)} border-0`}>
                {t(`account.subscription.plans.${user.plan.toLowerCase()}`)}
              </Badge>
          ...
          <div className='flex flex-col gap-4'>
            ...
            <div className='flex flex-col sm:flex-row items-center justify-center'>
              <div className='w-full sm:w-1/2 mb-2 sm:mb-0'>
                <div className='flex flex-col'>
                  <span className='text-sm'>
                    {t('account.subscription.projects')}
                  </span>
                  <span className='text-xs text-muted-foreground mt-1'>
                    {t('account.subscription.projectsDescription')}
                  </span>
                </div>
              </div>
            ...
            <div className='flex flex-col sm:flex-row items-center justify-center'>
              <div className='w-full sm:w-1/2 mb-2 sm:mb-0'>
                <div className='flex flex-col'>
                  <span className='text-sm'>
                    {t('account.subscription.feedbacks')}
                  </span>
                  <span className='text-xs text-muted-foreground mt-1'>
                    {t('account.subscription.feedbacksDescription')}
                  </span>
                </div>
              </div>
              <div className='w-full sm:w-1/2'>
